  ...
  return (
    <header className='bg-gray-200 rounded-lg'>
      <div className='flex flex-wrap justify-center items-center'>
        ...
        <div className='lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center invisible lg:visible flex justify-center items-center space-x-10'>
          <a
        ...
        <div className='w-full lg:w-4/12 px-4 md:order-1 flex justify-center py-4 lg:pt-4 pt-8 mt-8 lg:mt-0'>
