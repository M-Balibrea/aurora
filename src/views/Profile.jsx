...
export default function Profile({ name = null }) {
                  ...
                  <div className="flex flex-wrap justify-center">
                    <div className="w-full lg:w-9/12 px-4">
                      <p className="mb-4 text-lg leading-relaxed text-gray-800">
                        Specialist on Data Analytics, including Machine Learning methods, time series representation, missing values imputation and anomaly detection for Internet of Things.
                      </p>
                      <a
                        href="#pablo"
